...
Source0  : https://github.com/keepassxreboot/keepassxc/releases/download/2.7.10/keepassxc-2.7.10-src.tar.xz
Source1  : https://github.com/keepassxreboot/keepassxc/releases/download/2.7.10/keepassxc-2.7.10-src.tar.xz.sig
Source2  : B7A66F03B59076A8.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) B7A66F03B59076A8' gpg.status
%setup -q -n keepassxc-2.7.10
cd %{_builddir}/keepassxc-2.7.10
pushd ..
cp -a keepassxc-2.7.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741137029
mkdir -p clr-build
pushd clr-build
...
-DWITH_XC_YUBIKEY=ON  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
