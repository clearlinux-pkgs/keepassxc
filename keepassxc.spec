...
Version  : 2.7.8
Release  : 48
URL      : https://github.com/keepassxreboot/keepassxc/releases/download/2.7.8/keepassxc-2.7.8-src.tar.xz
Source0  : https://github.com/keepassxreboot/keepassxc/releases/download/2.7.8/keepassxc-2.7.8-src.tar.xz
Source1  : https://github.com/keepassxreboot/keepassxc/releases/download/2.7.8/keepassxc-2.7.8-src.tar.xz.sig
...
%setup -q -n keepassxc-2.7.8
cd %{_builddir}/keepassxc-2.7.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715007671
mkdir -p clr-build
pushd clr-build
